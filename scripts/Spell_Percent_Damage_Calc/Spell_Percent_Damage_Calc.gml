...
casterAFFBonus = ((((Caster.char_data[8]-25)/100))+1)
...
casterAFFBonus = ((((Caster.char_data[9]-25)/100))+1)
...
casterAFFBonus = ((((Caster.char_data[10]-25)/100))+1)
...
casterAFFBonus = ((((Caster.char_data[11]-25)/100))+1)
...
percentage =(SpellPower/32)*(casterAFFBonus*targetAFFBonus);
damage=Target.char_data[4]*percentage;
show_debug_message("SPELL PERCENTAGE DAMAGE against "+string(Target.char_data[0])+" = "+string(damage));
damage=round(damage);
return damage;
