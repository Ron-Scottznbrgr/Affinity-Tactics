...
var ATKRatio=10;
var DEFRatio=11;
var POWERRatio=18; //Should be 14?
var ATK_AFF_BONUS=2; //Should be 1?
...
casterAFFBonus = ((((Caster.char_data[8]-25)/100)*ATK_AFF_BONUS)+1)
...
casterAFFBonus = ((((Caster.char_data[9]-25)/100)*ATK_AFF_BONUS)+1)
...
casterAFFBonus = ((((Caster.char_data[10]-25)/100)*ATK_AFF_BONUS)+1)
...
casterAFFBonus = ((((Caster.char_data[11]-25)/100)*ATK_AFF_BONUS)+1)
