...
visible=false;
	...
	//global.target_range= (ds_grid_get(btn_Magic.char_Spell_List,obj_battle_cursor_right.cursor_spell_slot,2));
	btn_Magic.spell_range=(ds_grid_get(btn_Magic.char_Spell_List,obj_battle_cursor_right.cursor_spell_slot,2));
//show_debug_message("MAGIC BUTTON RANGE "+string(btn_Magic.spell_range));
